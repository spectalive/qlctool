...
| `movimiento sin apuntar` | An EFX moving beam-class fixtures whose tilt axis is centred on 127, the raw middle of the channel - what QLC+ writes when nobody aims the figure. A wash's wide cone survives it; a 2-degree needle does not | "Está todo el rato haciendo un circulo pequeño en el suelo": every movement EFX the generator had ever written carried the default `<Axis Name="Y"><Offset>127`, and on this rig mid-travel is the floor (2026-08-29) |
