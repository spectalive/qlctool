...
CAPTION_PROMISES: dict[str, tuple[str, ...]] = {
    ...
    "page_control_no_intensity": (HAZE, BEAM_WHEEL, HEADS),
    "page_control_no_haze": (BEAM_WHEEL, HEADS),
    "page_control_no_haze_no_intensity": (BEAM_WHEEL, HEADS),
    "page_control_no_beam_wheel": (HAZE, HEADS),
    "page_control_no_beam_wheel_no_intensity": (HAZE, HEADS),
    "page_control_no_haze_no_beam_wheel": (HEADS,),
    "page_control_no_haze_no_beam_wheel_no_intensity": (HEADS,),
    "page_control_no_heads": (HAZE,),
    "page_control_no_heads_no_intensity": (HAZE,),
    "page_control_no_haze_no_heads": (),
    "page_control_no_haze_no_heads_no_intensity": (),
}
