...
the rig has (`tempo_help_line`, `matrices_frame_caption`, `library_help_lines`,
`page_control_title`); this table is the other half, read by `rule_caption_promise`:
every identifier those four can choose, and what its text promises.
...
CAPTION_PROMISES: dict[str, tuple[str, ...]] = {
    ...
    "matrices_frame": (PIXEL_GROUP, BUILTIN_EFFECTS),
    "matrices_frame_groups": (),
    "library_1": (BUILTIN_EFFECTS,),
    "library_2": (BUILTIN_EFFECTS,),
    "library_6": (BUILTIN_EFFECTS,),
