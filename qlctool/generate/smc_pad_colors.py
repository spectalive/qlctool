...
console paints the button this colour; the LED bridge (`qlc_led_bridge.swift`
in spectalive/smc-pad) paints the pad the same colour, dimmed while the
function is idle and full-bright while it is active. Keep the two
