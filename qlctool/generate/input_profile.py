...
EDGE_BUTTONS = (
    ...
    (26, "> (pagina siguiente)"),
    (27, "Play (libre)"),
    # The manual names CC 28 STOP; the show's console calls its button Pausa.
    (28, "Stop (PARAR TODO)"),
    (29, "Rec (APAGON)"),
)
...
HEADER_COMMENT = """
  ...
  qlctool/generate/smc_pad_device.py in spectalive/qlctool - edit that map,
  not this file, or the profile and the show's bindings drift apart again.

  Measured 2026-08-29 over USB and Bluetooth (midicap.swift in
  spectalive/smc-pad). Only what was measured is declared. The
